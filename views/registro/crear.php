<main class="registro">
    ...
    <div class="paquetes__grid">
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Presencias a DevWebCamp</li>
...
<script src="https://www.paypal.com/sdk/js?client-id=AYFf3b0hxqG8Vqz8npEl0IN1RpSMdbGexx3zqEgvI8sx7mJIEj3CetjsCvxxg9avzPvbPycFjFC1E_25&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
