...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="tags_input" class="formulario__label">Áreas de Experencia (separadas por coma)</label>
        <input type="text" class="formulario__input" id="tags_input" placeholder="Ej: Vue.js, PHP, SQL, CSS, Laravel, UX / UI">
